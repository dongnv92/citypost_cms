<?php
    ...
    if($submit){
        ...
        $device_fullname= (isset($_POST['device_fullname']) && !empty($_POST['device_fullname']))   ? $_POST['device_fullname'] : '';
        $device_address = (isset($_POST['device_address'])  && !empty($_POST['device_address']))    ? $_POST['device_address']  : '';
        ...
        // Thêm hoặc sửa dữ liệu vào bảng Member
        if(!updateGlobal('dong_member', array('member_status' => 0), array('member_device' => $device_code.$device_token))){
            echo json_decode(array('error' => "Can't Update Member Status"));
            exit();
        }
        ...
        $data = array(
            ...
            'member_device'     => $device_code,
            'member_status'     => 1,
            'member_time'       => time()
        );
        $member = insertGlobal('dong_member', $data);
        if(!$member){
            echo json_decode(array('error' => "Can't Insert Member"));
            exit();
        }
        // Thêm hoặc sửa dữ liệu vào bảng Member
		                ...
		                <div class="card wizard-card" data-color="blue" id="wizardProfile">
                            ...
                            <form action="" method="post">
								...
								<div class="wizard-navigation">
									<ul>
			                            <li><a href="#about" data-toggle="tab">Thiết bị</a></li>
		                            ...
		                            <div class="tab-pane" id="about">
		                                <div class="row">
                                            <div class="text-center text-danger">
                                                <?php
                                                if($submit && !$error){
                                                    echo 'Cảm ơn bạn đã dùng sản phẩm. Đơn hàng của bạn đã được xử lý và bạn sẽ nhận được 1 email xác nhận<br />';
                                            ...
                                            <h4 class="info-text"> Mã thiết bị được in ở dưới thiết bị </h4>
                                            <div class="col-sm-7 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Mã thiết bị</label>
                                                    <input type="text" required name="device_code" value="<?php echo $device_code;?>" class="form-control upercase">
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Mã Token</label>
                                                    <input type="text" required name="device_token" value="<?php echo $device_token;?>" class="form-control upercase">
                                                </div>
                                            </div>
		                            	</div>
		                            </div>
                                                        ...
                                                        <?php
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><input style="width: 60px; text-align: center" type="number" name="device_product_<?php echo $product['id'];?>" value="0" min="0" max="100" step="1"/></td>
                                                                </tr>
                                                            <?php
                                                            }
                                                        ?>
		                        ...
		                        <div class="wizard-footer">
		                            <div class="pull-right">
		                                ...
		                                <input type='submit' class='btn btn-finish btn-fill btn-success btn-wd' name='submit' value='Gửi thông tin' />
		                            </div>
