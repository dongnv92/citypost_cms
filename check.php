...
<head>
    ...
    <title>Search Page - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin
        Dashboard
    </title>
            ...
            <div class="row full-height-vh-with-nav">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-lg-6 col-10">
                        <img class="img-fluid mx-auto d-block pb-3 pt-4 width-65-per" src="../../../app-assets/images/logo/logo-dark-lg.png"
                             alt="Modern Search">
                        ...
                        <div class="row py-2">
                            <div class="col-12 text-center">
                                ...
                                <span class="dropdown">
                    <button id="btnSearchDrop" type="button" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="true" class="btn btn-warning  btn-md dropdown-toggle dropdown-menu-right"><i class="la la-cog"></i> Advanced search</button>
